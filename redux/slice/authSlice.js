    ...
    updateUserProfile: (state, action) => {
      if (state.user) {
        ...
        state.user = {
          ...
          company_address:
            updatedData.company_address ?? state.user.company_address,
          company_name: updatedData.company_name ?? state.user.company_name,
          company_registered_number:
            updatedData.company_registered_number ??
            state.user.company_registered_number,
          ...
          upload_organisation:
            updatedData.upload_organisation ?? state.user.upload_organisation,
        };
      }
    },
  },
...
export const { setLogin, setLogout, setSignUp, updateUserProfile } =
  authSlice.actions;
