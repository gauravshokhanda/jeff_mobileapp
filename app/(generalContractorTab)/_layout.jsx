        ...
        <ProtectedRoute>
            <Tabs screenOptions={{
                ...
                <Tabs.Screen
                    name='ContractorFeed'
                    options={{
                        title: "ContractorFeed", tabBarIcon: ({ color, focused }) => (
                            <Ionicons name={focused ? "grid" : "grid-outline"} color="white" size={30} />),
                        tabBarLabelStyle: {
                            display: 'none'
                        },
                    }}
                ...
                <Tabs.Screen
                    ...
                    options={{
                        title: "ContractorPortfolio", tabBarIcon: ({ color, focused }) => (
                            <Ionicons name={focused ? "albums" : "albums-outline"} color="white" size={30} />
                        ),
                        tabBarLabelStyle: {
                            display: 'none'
                        },
                ...
                <Tabs.Screen
                    name='AddPortfolio'
                    options={{
                        title: "AddPortfolio", tabBarIcon: ({ color, focused }) => (
